...
class ProgramSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $programs = [
            ...
            [
                'name' => 'Kajian Muslimah Akhir Pekan',
                'description' => 'Kajian khusus muslimah yang diselenggarakan setiap akhir pekan, membahas isu-isu kewanitaan dalam pandangan Islam.',
                'content' => '<h3>Kajian Muslimah Akhir Pekan</h3><p>Wadah berkumpulnya muslimah untuk menuntut ilmu dan bersilaturahmi. Kajian ini diisi oleh ustadzah-ustadzah berpengalaman.</p><h4>Materi Kajian</h4><ul><li>Fiqih Wanita</li><li>Tarbiyatul Aulad (Mendidik Anak)</li><li>Kesehatan Muslimah</li></ul>',
                'icon' => 'fas fa-female',
                'type' => 'regular',
                'frequency' => 'weekly',
                'start_time' => '09:00:00',
                'end_time' => '11:00:00',
                'location' => 'Aula Serbaguna Lt. 1',
                'organizer' => 'Majelis Taklim Ibu-Ibu Al Azhar',
                'speaker' => 'Ustadzah Oki Setiana Dewi',
                'is_active' => true,
                'order' => 9,
            ],
            [
                'name' => 'Santunan Anak Yatim Dhuafa',
                'description' => 'Program sosial rutin pemberian santunan untuk anak yatim dan dhuafa di lingkungan sekitar Masjid Agung Al Azhar.',
                'content' => '<h3>Santunan Anak Yatim dan Dhuafa</h3><p>Kegiatan sosial sebagai bentuk kepedulian jamaah Masjid Agung Al Azhar kepada sesama. Dana santunan berasal dari infaq jamaah.</p><h4>Bentuk Santunan</h4><ul><li>Uang tunai</li><li>Sembako</li><li>Peralatan sekolah</li></ul>',
