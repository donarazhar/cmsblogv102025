...
@section('content')
    <div class="page-header">
        <h1 class="page-title">Tambah Category Baru</h1>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                required placeholder="Masukkan nama category">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="slug" name="slug"
                                ...
                                placeholder="akan-otomatis-dibuat-dari-nama">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror"
                                rows="5" placeholder="Deskripsi category (opsional)">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card" style="margin-top: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 15px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="color" id="color" name="color"
                                    ...
                                    value="{{ old('color', '#0053C5') }}" style="height: 45px;">
                                @error('color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div id="iconPreview"
                            ...
                            <div
                                style="width: 80px; height: 80px; background: #0053C5; border-radius: 12px; display: inline-flex; align-items: center; justify-content: center; color: white;">
                                <i id="previewIcon" class="fas fa-folder" style="font-size: 2rem;"></i>
                            </div>
                    ...
                    <div class="card-body">
                        <div style="font-size: 0.9rem; line-height: 1.6; color: #6b7280;">
                            <p style="margin-bottom: 15px;">
                                <strong>Category</strong> digunakan untuk mengelompokkan konten/posts.
                            </p>
                            <p style="margin-bottom: 15px;">
                                <strong>Parent Category:</strong> Pilih parent jika ingin membuat sub-category.
                            </p>
                            <p style="margin-bottom: 15px;">
                                <strong>Order:</strong> Menentukan urutan tampilan. Semakin kecil angka, semakin atas
                                posisinya.
                            </p>
                            <p style="margin-bottom: 0;">
                                <strong>Icon:</strong> Gunakan Font Awesome icon class. Lihat di
                                <a href="https://fontawesome.com/icons" target="_blank"
                                    style="color: var(--primary);">fontawesome.com</a>
                            </p>
                        </div>
                    </div>
                </div>
