                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                required placeholder="Masukkan judul slider">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="form-control @error('description') is-invalid @enderror" placeholder="Masukkan deskripsi slider (opsional)">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Image Upload -->
                        <div class="form-group">
                            <label for="image">Gambar Slider <span class="required">*</span></label>
                            <div class="image-upload-wrapper">
                                <input type="file" name="image" id="image"
                                    class="form-control-file @error('image') is-invalid @enderror" accept="image/*" required
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="button_text" id="button_text"
                                        ...
                                        value="{{ old('button_text') }}" placeholder="Contoh: Selengkapnya">
                                    @error('button_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="button_text_2" id="button_text_2"
                                        ...
                                        value="{{ old('button_text_2') }}" placeholder="Contoh: Hubungi Kami">
                                    @error('button_text_2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="button_link_2" id="button_link_2"
                                        ...
                                        value="{{ old('button_link_2') }}" placeholder="https://example.com">
                                    @error('button_link_2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="text_position" id="text_position"
                                ...
                                <option value="left" {{ old('text_position', 'left') == 'left' ? 'selected' : '' }}>Kiri
                                </option>
                                <option value="center" {{ old('text_position') == 'center' ? 'selected' : '' }}>Tengah
                                </option>
                                <option value="right" {{ old('text_position') == 'right' ? 'selected' : '' }}>Kanan
                                </option>
                            </select>
                            @error('text_position')
                                <div class="invalid-feedback">{{ $message }}</div>
