...
@section('content')
    <div class="page-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1 class="page-title">Edit Foto Gallery</h1>
    ...
    <form action="{{ route('admin.gallery.photos.update', $photo) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                value="{{ old('title', $photo->title) }}" required placeholder="Masukkan judul foto">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi foto (opsional)">{{ old('description', $photo->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror"
                                ...
                                <option value="image" {{ old('type', $photo->type) == 'image' ? 'selected' : '' }}>
                                    Image</option>
                                <option value="video" {{ old('type', $photo->type) == 'video' ? 'selected' : '' }}>
                                    Video</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="form-group" id="videoField" style="display: none;">
                            ...
                            <input type="url" name="video_url" id="video_url"
                                ...
                                value="{{ old('video_url', $photo->video_url) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="order" id="order"
                                ...
                                value="{{ old('order', $photo->order) }}" min="0">
                            @error('order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div style="font-size: 0.85rem; color: #6b7280;">
                                <strong>Album:</strong> {{ $photo->album ? $photo->album->name : '-' }}<br>
                                <strong>Uploaded:</strong> {{ $photo->created_at->format('d M Y H:i') }}
                            </div>
                        </div>
                    </div>
                @endif
