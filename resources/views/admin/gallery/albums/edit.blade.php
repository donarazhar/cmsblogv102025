...
@section('content')
    ...
    <form action="{{ route('admin.gallery.albums.update', $album) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                value="{{ old('name', $album->name) }}" required placeholder="Contoh: Ramadhan 1445 H">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" id="slug"
                                ...
                                value="{{ old('slug', $album->slug) }}" placeholder="akan dibuat otomatis jika kosong">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi album (opsional)">{{ old('description', $album->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text">Kosongkan jika tidak ingin mengubah cover</small>
                            @error('cover_image')
