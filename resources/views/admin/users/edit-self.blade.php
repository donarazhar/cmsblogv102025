...
@section('content')
    <style>
        ...
        .form-hint { font-size: 0.85rem; color: #6b7280; margin-top: 6px; }
        ...
        .user-info-name { font-size: 1.3rem; font-weight: 700; }
        .user-info-email { opacity: 0.8; font-size: 0.95rem; }
        .user-info-date { opacity: 0.7; font-size: 0.85rem; margin-top: 3px; }
        .role-badge {
            display: inline-block; padding: 3px 10px; border-radius: 20px;
            font-size: 0.75rem; font-weight: 600; margin-top: 5px;
    ...
    <div class="card">
        <div class="card-header">
            <h2 class="card-title"><i class="fas fa-user-edit" style="color: var(--primary); margin-right: 10px;"></i>Edit Akun Saya</h2>
        </div>
        <div class="card-body">
