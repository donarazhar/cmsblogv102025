...
@section('content')
    <div class="page-header">
        ...
        <p class="page-subtitle">Buat pengumuman atau informasi penting untuk jamaah</p>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group col-span-3">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                            name="title" value="{{ old('title') }}" placeholder="Contoh: Kajian Rutin Jumat Malam"
                            required>
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon"
                            name="icon" value="{{ old('icon') }}" placeholder="fas fa-bullhorn">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('link_text') is-invalid @enderror" id="link_text"
                            name="link_text" value="{{ old('link_text') }}" placeholder="Selengkapnya">
                        @error('link_text')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div> <!-- Tanggal Mulai -->
