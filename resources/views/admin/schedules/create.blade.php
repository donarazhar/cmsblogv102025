...
@section('content')
    <div class="page-header">
        ...
        <p class="page-subtitle">Buat jadwal sholat, kajian, atau kegiatan masjid baru</p>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type"
                            ...
                            <option value="prayer" {{ old('type') == 'prayer' ? 'selected' : '' }}>Sholat</option>
                            <option value="event" {{ old('type') == 'event' ? 'selected' : '' }}>Acara</option>
                            <option value="lecture" {{ old('type') == 'lecture' ? 'selected' : '' }}>Kajian</option>
                    ...
                    <div class="form-group col-span-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                            rows="3" placeholder="Deskripsi singkat tentang jadwal ini">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-span-3">
                        <div class="form-check-switch">
                            <input type="checkbox" id="is_recurring" name="is_recurring" value="1"
                                {{ old('is_recurring') ? 'checked' : '' }} onchange="toggleRecurring()">
                    ...
                    <div class="form-group" id="day-field" style="display: none;">
                        ...
                        <select class="form-select @error('day_of_week') is-invalid @enderror" id="day_of_week"
                            ...
                            <option value="wednesday" {{ old('day_of_week') == 'wednesday' ? 'selected' : '' }}>Rabu
                            </option>
                            <option value="thursday" {{ old('day_of_week') == 'thursday' ? 'selected' : '' }}>Kamis
                            </option>
                            <option value="friday" {{ old('day_of_week') == 'friday' ? 'selected' : '' }}>Jumat</option>
                            <option value="saturday" {{ old('day_of_week') == 'saturday' ? 'selected' : '' }}>Sabtu
                            </option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('location') is-invalid @enderror" id="location"
                            name="location" value="{{ old('location') }}" placeholder="Contoh: Ruang Utama, Aula, dll">
                        @error('location')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('imam') is-invalid @enderror" id="imam"
                            name="imam" value="{{ old('imam') }}" placeholder="Nama Imam">
                        @error('imam')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('speaker') is-invalid @enderror" id="speaker"
                            name="speaker" value="{{ old('speaker') }}" placeholder="Nama Pemateri">
                        @error('speaker')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="color-input-group">
                            <input type="color" class="form-control-color @error('color') is-invalid @enderror"
                                id="color" name="color" value="{{ old('color', '#0053C5') }}">
                            <input type="text" class="form-control" id="color-hex"
                                value="{{ old('color', '#0053C5') }}" readonly>
                        </div>
