                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title"
                                ...
                                value="{{ old('title', $post->title) }}" required placeholder="Masukkan judul post">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="slug" name="slug"
                                ...
                                value="{{ old('slug', $post->slug) }}" placeholder="akan-otomatis-dibuat-dari-judul">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="featured_video" name="featured_video"
                                ...
                                value="{{ old('featured_video', $post->featured_video) }}"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="meta_title" name="meta_title"
                                ...
                                value="{{ old('meta_title', $post->meta_title) }}" placeholder="Judul untuk SEO">
                            @error('meta_title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="meta_description" name="meta_description"
                                ...
                                placeholder="Deskripsi untuk SEO">{{ old('meta_description', $post->meta_description) }}</textarea>
                        ...
                        <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid var(--border);">
                            <div style="background: var(--light); padding: 15px; border-radius: 8px; margin-bottom: 15px;">
                                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                    <span style="font-size: 0.9rem; color: #6b7280;">Views:</span>
                                    <strong>{{ number_format($post->views_count) }}</strong>
                                </div>
                                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                    <span style="font-size: 0.9rem; color: #6b7280;">Reading Time:</span>
                                    <strong>{{ $post->reading_time }} min</strong>
                                </div>
                                <div style="display: flex; justify-content: space-between;">
                                    <span style="font-size: 0.9rem; color: #6b7280;">Comments:</span>
                        ...
                        <div class="form-group">
                            ...
                            <select id="post_type" name="post_type"
                                ...
                                <option value="article"
                                    {{ old('post_type', $post->post_type) == 'article' ? 'selected' : '' }}>Article
                                </option>
                                <option value="news"
                                    {{ old('post_type', $post->post_type) == 'news' ? 'selected' : '' }}>News</option>
                                <option value="announcement"
                                    {{ old('post_type', $post->post_type) == 'announcement' ? 'selected' : '' }}>
                                    Announcement</option>
                                <option value="event"
                                    {{ old('post_type', $post->post_type) == 'event' ? 'selected' : '' }}>Event</option>
                            </select>
                            @error('post_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
