...
@section('content')
    <div class="page-header">
        ...
        <p class="page-subtitle">Buat halaman statis untuk website masjid</p>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('template') is-invalid @enderror" id="template"
                                ...
                                <option value="full-width" {{ old('template') == 'full-width' ? 'selected' : '' }}>Full
                                    Width</option>
                                <option value="sidebar-left" {{ old('template') == 'sidebar-left' ? 'selected' : '' }}>
                                    Sidebar Left</option>
                                <option value="sidebar-right" {{ old('template') == 'sidebar-right' ? 'selected' : '' }}>
                                    Sidebar Right</option>
                                <option value="contact" {{ old('template') == 'contact' ? 'selected' : '' }}>Contact
                                </option>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('menu_order') is-invalid @enderror"
                                id="menu_order" name="menu_order" value="{{ old('menu_order') }}" min="0">
                            @error('menu_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
