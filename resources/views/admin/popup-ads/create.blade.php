...
@section('title', 'Tambah Popup Iklan')

@section('content')
    <div class="page-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1 class="page-title">Tambah Popup Iklan</h1>
    ...
    <form action="{{ route('admin.popup-ads.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required placeholder="Contoh: Teks Khutbah Jumat 1447 H">
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subtitle" id="subtitle" class="form-control @error('subtitle') is-invalid @enderror" value="{{ old('subtitle') }}" placeholder="Contoh: Masjid Agung Al Azhar">
                            @error('subtitle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Image Upload -->
                        <div class="form-group">
                            <label for="banner_image">Gambar Banner <span class="required">*</span></label>
                            <div class="image-upload-wrapper">
                                <input type="file" name="banner_image" id="banner_image" class="form-control-file @error('banner_image') is-invalid @enderror" accept="image/*" required onchange="previewImage(this)">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text">Maksimal 10MB. File ini akan dibuka ketika popup diklik.</small>
                                    @error('pdf_file')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text">Semakin kecil angkanya, semakin tinggi prioritasnya jika ada multiple popup.</small>
                            @error('order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="show_delay" id="show_delay" class="form-control @error('show_delay') is-invalid @enderror" value="{{ old('show_delay', 1500) }}" min="0" required>
                            <small class="form-text">Contoh: 1500 = 1.5 detik setelah halaman dimuat.</small>
                            @error('show_delay')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="target_routes" id="target_routes" class="form-control @error('target_routes') is-invalid @enderror" value="{{ old('target_routes') }}" placeholder="Misal: /programs, /berita/*">
